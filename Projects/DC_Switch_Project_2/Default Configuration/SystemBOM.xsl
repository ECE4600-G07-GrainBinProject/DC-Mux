      ...
      <BODY>
        <TABLE style="font:8pt Segoe UI" border="1" CELLSPACING="0" CELLPADDING="1" BGCOLOR="#FFFFFF">
          ...
          <TR valign="top">
            ...
            <TD align="left">
              <xsl:value-of select="@ComponentLink1Description1"/>
              <xsl:if test="@ComponentLink1Description1[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@ComponentLink1URL1"/>
              <xsl:if test="@ComponentLink1URL1[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@ComponentLink2Description1"/>
              <xsl:if test="@ComponentLink2Description1[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@ComponentLink2URL1"/>
              <xsl:if test="@ComponentLink2URL1[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@DatasheetVersion1"/>
              <xsl:if test="@DatasheetVersion1[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@Model_PCB3D1"/>
              <xsl:if test="@Model_PCB3D1[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@PackageVersion1"/>
              <xsl:if test="@PackageVersion1[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
